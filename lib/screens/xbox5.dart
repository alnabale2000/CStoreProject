...
//
// class XBox5Store extends StatelessWidget {
...
class XBox5Store extends StatefulWidget {
  final List<String> results;
  final bool loading;

  XBox5Store({this.results, this.loading});

  @override
  _XBox5StoreState createState() => _XBox5StoreState();
}

class _XBox5StoreState extends State<XBox5Store> {
      ...
      title: Container(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            ...
            hintText: Languages.of(context).x5SearchHint,
