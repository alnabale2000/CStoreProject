...
class Ps4Store extends StatefulWidget {
  final List<String> results;
  final bool loading;

  Ps4Store({this.results, this.loading});

  @override
  _Ps4StoreState createState() => _Ps4StoreState();
}

class _Ps4StoreState extends State<Ps4Store> {
      ...
      title: Container(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            ...
            hintText: Languages.of(context).ps4SearchHint,
