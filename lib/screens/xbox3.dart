...
class XBox3Store extends StatefulWidget {
  final List<String> results;
  final bool loading;

  XBox3Store({this.results, this.loading});

  @override
  _XBox3StoreState createState() => _XBox3StoreState();
}

class _XBox3StoreState extends State<XBox3Store> {
      ...
      title: Container(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            ...
            hintText: Languages.of(context).x3SearchHint,
