...
class Ps3Store extends StatefulWidget {
  final List<String> results;
  final bool loading;

  Ps3Store({this.results, this.loading});

  @override
  _Ps3StoreState createState() => _Ps3StoreState();
}

class _Ps3StoreState extends State<Ps3Store> {
  ...
  SliverAppBar buildSliverAppBar(BuildContext context) {
    return SliverAppBar(
      ...
      leading: IconButton(
        ...
        icon: Icon(Icons.arrow_back, size: 25, color: kPsBigColor),
      ),
      floating: true,
      pinned: true,
      backgroundColor: Colors.white,
      ...
      title: TextField(
        ...
        decoration: InputDecoration(
          ...
          hintText: Languages.of(context).ps3SearchHint,
